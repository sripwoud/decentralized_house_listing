...
contract Ownable {
    // set visibility of owner as public to avoid defining redundantly a public getter
...
contract ERC721 is Pausable, ERC165 {
    ...
    */
    ...
    function balanceOf(address owner) public view returns (uint256 balance) {
        balance = _ownedTokensCount[owner].current();
    }
    ...
    function approve(address to, uint256 tokenId) public
    {
        ...
        require(to != tokenOwner, "To address already owns this token");
        ...
        require(
            ...
            "Only token owner or an approved operator can perform this action");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "Caller must be token owner");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    // visibility set as public to avoid having to define getters
    string public name;
    ...
    constructor (string memory n, string memory s, string memory bTU) public {
        name = n;
        symbol = s;
        baseTokenURI = bTU;
    ...
    // Sets the tokenURI of a specified tokenId
...
contract DecentralizedHousingToken is ERC721Metadata("Decentralized Housing Token", "DHT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
